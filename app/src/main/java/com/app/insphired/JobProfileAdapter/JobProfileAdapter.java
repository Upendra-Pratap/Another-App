package com.app.insphired.JobProfileAdapter;
...
import com.app.insphired.apimodel.JobsList;
...
public class JobProfileAdapter extends RecyclerView.Adapter<JobProfileAdapter.ViewHolder> {
    ...
    @NonNull
    @Override
    public JobProfileAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    public void onBindViewHolder(JobProfileAdapter.ViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        holder.deleteIconFListJobb.setOnClickListener(v -> {
    ...
    private void deleteJobApi(String idd, int position, String table) {
        ...
        call.enqueue(new Callback<DeleteJobmodel>() {
            ...
            @Override
            public void onResponse(@NonNull Call<DeleteJobmodel> call, @NonNull Response<DeleteJobmodel> response) {
                pd.dismiss();
                try {
            ...
            @Override
            public void onFailure(@NonNull Call<DeleteJobmodel> call, @NonNull Throwable t) {
