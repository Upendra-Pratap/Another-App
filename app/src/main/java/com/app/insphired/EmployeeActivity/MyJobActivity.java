...
import com.app.insphired.adapters.MyJobAdapter;
import com.app.insphired.apimodel.MyJobModel;
import com.app.insphired.apimodel.MyJobModelData;
...
public class MyJobActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RequestsJobsBtn = findViewById(R.id.RequestsJobsBtn);
        ...
        RequestsJobsBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(MyJobActivity.this,RequestJobsActivity.class);
