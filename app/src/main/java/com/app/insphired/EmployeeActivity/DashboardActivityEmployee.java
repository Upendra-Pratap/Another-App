...
import static com.app.insphired.R.color.skyBlue;
import static com.app.insphired.R.color.white;
...
import com.app.insphired.EmployeeFragment.HomeFragmentEmployee;
import com.app.insphired.EmployeeFragment.MyJobsFragment;
import com.app.insphired.EmployeeFragment.ProfileFragmentEmployee;
import com.app.insphired.EmployeeFragment.WalletsFragmentEmployee;
import com.app.insphired.R;
import com.app.insphired.databinding.ActivityDashboardEmployeeBinding;
...
public class DashboardActivityEmployee extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.homeLayoutEmployee.setOnClickListener(v -> {
            navItemIndex = 1;
        ...
        binding.appointmentsLayout.setOnClickListener(v -> {
            navItemIndex = 2;
        ...
        binding.walletLayoutEmployee.setOnClickListener(v -> {
            navItemIndex = 3;
        ...
        binding.profileLayoutEmployee.setOnClickListener(v -> {
            navItemIndex = 4;
