...
public class WebViewActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // String finalUrl ="http://192.168.1.17/insphire/card_payment?";
         ...
         {
             String finalUrl = "https://worx.insphired.jobs/card_payment?" + "employee_id=" + employeeId + "&employer_id=" + UserId + "&amount="+
                     totalAmount + "&time_slot_id=" + slotid + "&user_type=" + UserType;

             webView.loadUrl(finalUrl);

             Log.e("urlWebview", "url"+finalUrl);
         }

         else
         {
             String finalUrl = "https://worx.insphired.jobs/invoice?"+"employee_id="+employeeId +"&employer_id="+UserId+"&time_slot_id=" + slotid+"&user_type="+UserType+"&amount="+
