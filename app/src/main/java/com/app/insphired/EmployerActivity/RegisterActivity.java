...
import com.app.insphired.apimodel.RegisterModelData;
...
public class RegisterActivity extends AppCompatActivity {
    ...
    RelativeLayout relativeCompanyNamereg, relativeUploadd;
    LinearLayout RelativeUploadVideo;
    ...
    private String strFirstName, strLastName, strEmail, strPassword, strPhone, StrTEmployer, StrJobseeker,login_type="2";
    ...
    private File profile_Identity;
    private File profile_fileVideo;
    private Uri pdfUri;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        regArrowBackImg.setOnClickListener(v -> finish());

        SignInEmployeeReg.setOnClickListener(v -> {
            Intent intent = new Intent(RegisterActivity.this, LoginActivity.class);
            startActivity(intent);
        });

        regPasswordHidden.setOnClickListener(v -> {
        ...
        regPasswordShow.setOnClickListener(v -> {
        ...
        regConfirmPShow.setOnClickListener(v -> {
        ...
        regConfirmPHidden.setOnClickListener(v -> {
        ...
        sendOTPReg.setOnClickListener(v -> {
            clickedOtp = true;
        ...
        uploadPdetailsBtn.setOnClickListener(v -> {
            clickedVideo = true;
            ...
            select_Pfile_layout.setOnClickListener(v1 -> {
                selectPdf();
        ...
        uploadReg.setOnClickListener(v -> {
            ...
            choose_video_layout.setOnClickListener(v12 -> {
                openGalleryForVideo();
                selectVideo.dismiss();
            });
        });
        ...
        regSignUpButton.setOnClickListener(v -> {
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
     ...
     /*   if (requestCode == REQUEST_VIDEO_PICK && resultCode == RESULT_OK) {
            ...
            if (videoUri != null) {
                // Only assign selectedVideoUri once
                ...
                if (uriString.startsWith("content://")) {
                    ...
                    try {
                        ...
                        if (cursor != null && cursor.moveToFirst()) {
                            ...
                            // Get the actual file path from the content URI (Display name might not be the actual path)
                            File videoFile = new File(getExternalFilesDir(Environment.DIRECTORY_MOVIES), videoName);
                            saveVideoToFile(videoUri, videoFile);
                            profile_fileVideo = videoFile;
    ...
    private void openDialog() {
        ...
        verifyOtpReg.setOnClickListener(view -> {
        ...
        crossOtpreg.setOnClickListener(v -> getOtpDialog1.dismiss());
    ...
    private void registerEmployee_Api() {
        ...
        RequestBody token = RequestBody.create(MediaType.parse("text/plain"), fcmToken);
        RequestBody loginTyp = RequestBody.create(MediaType.parse("text/plain"), login_type);
        ...
        retrofit2.Call<RegisterModel> call = service.REGISTER_MODEL_CALL(RName, REmail, RPassword, RPhone, profVideo, profIdent, RAdmin, token,loginTyp);
